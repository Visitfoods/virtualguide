...
export async function GET() {
	try {
		...
		console.log('Ficheiro encontrado:', videoPath);
		console.log('Tamanho:', stats.size, 'bytes');
		
		// Ler o ficheiro de vídeo
		console.log('Lendo ficheiro de vídeo...');
		...
		console.log(`Tamanho do vídeo: ${fileBuffer.length} bytes (${(fileBuffer.length / (1024 * 1024)).toFixed(2)} MB)`);
